...
## 💻 Prerequisites
You need a Windows partition to run the software. [Mircosoft.net](https://dotnet.microsoft.com/en-us/download/dotnet/5.0) has to be installed. You are prompted to install the framework, when starting the software for the first time. Additionally a 3-button mouse and a keyboard are recommended.
